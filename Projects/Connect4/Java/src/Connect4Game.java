...
public class Connect4Game {
     ...
     * Your agent will not need to use this method.
     *
     * @return 'R' if red won, 'Y' if yellow won, 'N' if the game has not been
     * won.
     */
    public char gameWon() {
        char[][] board = getBoardMatrix();
    ...
    /**
     * Check whether red played first. This is used to confirm the players are
    ...
    /**
     * Sets whether red played first. This is used to confirm the players are
     * alternating correctly.
     *
     * Your agent will not need to use this method.
     *
     * @param redPlayedFirst true if red played first in this game, false
     * otherwise.
     */
